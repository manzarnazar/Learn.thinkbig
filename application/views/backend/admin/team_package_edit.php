...
$course_status = $team_package_details['privacy'];
if ($course_status == 'public') {
    $course_status = 'active';
}

$selected_course_price = 0;
$selected_course_expiry = null;
$courses = $this->team_package_model->get_status_wise_courses($course_status);

foreach ($courses as $course) {
    if ($course['id'] == $team_package_details['course_id']) {
        $selected_course_price = $course['price'];
        $selected_course_expiry = $course['expiry_period'];
    }
}
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="privacy" id="privacy" required>
                                                            ...
                                                            <option value="public" <?php if ($team_package_details['privacy'] == "public") echo 'selected'; ?>>
                                                                <?php echo get_phrase('create_package_with_public_course'); ?></option>
                                                            <option value="private" <?php if ($team_package_details['privacy'] == "private") echo 'selected'; ?>>
                                                                <?php echo get_phrase('create_package_with_private_course'); ?></option>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="course_id" id="course_id_on_package_create">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="max_students_for_package_create" value="<?php echo $team_package_details['max_students']; ?>" name="max_students" placeholder="<?php echo get_phrase('enter_the_maximum_students_limit'); ?>" min="0">
                                                    </div>
                                                </div>


                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="pkg_status"><?php echo get_phrase('status'); ?> <span class="required">*</span> </label>
                                    ...
                                    <div class="tab-pane" id="pricing">
                                        <div class="row justify-content-center">
                                            <div class="col-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_expiry_info"><?php echo get_phrase('course_expiry_period'); ?></label>
                                                    <div class="col-md-10">
                                                        <input class="form-control" id="course_expiry_info" value="<?php echo $selected_course_expiry; ?>" name="course_expiry_info" placeholder="<?php echo get_phrase('course_expiration_months'); ?>" min="0" readonly>
                                                        <small class="text-muted"><?php echo get_phrase('course_expirey_period_set_on_course_creation'); ?>.
                                                            <?php echo get_phrase('does not affect the package expiry period'); ?></small>
                                                    </div>
                                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.expiry_period == null) {
                            ...
                            $("#course_expiry_info").val('Lifetime');
                            ...
                            $("#course_expiry_info").val(response.expiry_period + ' months');
